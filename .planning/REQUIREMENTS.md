...
- [x] **RES-02**: Adicionar verificação de sanidade ao parser XLSX (limites plausíveis de consumo, colunas esperadas)
...
- [x] **MULTI-05**: Refactorizar `reminder_job.py` para enviar notificação por local
